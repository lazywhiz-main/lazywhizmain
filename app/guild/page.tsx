        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <div className="card p-8">
              ...
              <h3 className="text-xl font-heading mb-4 text-text-high">ネットワーキング</h3>
              <p className="mb-0 text-text-medium font-body opacity-80">様々な分野のプロフェッショナルとの出会いで、あなたのキャリアやプロジェクトが広がります。</p>
            </div>
            <div className="card p-8">
              <div className="w-16 h-16 bg-brand-100 text-brand-500 rounded-full flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
              ...
              <h3 className="text-xl font-heading mb-4 text-text-high">知識共有</h3>
              <p className="mb-0 text-text-medium font-body opacity-80">最新の業界動向やスキル向上のためのリソースにアクセスし、継続的な学習環境を手に入れましょう。</p>
            </div>
            <div className="card p-8">
              <div className="w-16 h-16 bg-brand-100 text-brand-500 rounded-full flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
              ...
              <h3 className="text-xl font-heading mb-4 text-text-high">コラボレーション</h3>
              <p className="mb-0 text-text-medium font-body opacity-80">協力して新しいプロジェクトに取り組み、個人では実現できない大きな成果を生み出します。</p>
            </div>
          </div>
        </div>
      </section>
